...
def run_processing_pipeline(config):
    ...
    # plot_normals(
    #     normals,
    #     north_line=dam_line,           # 你函数里“左岸线”→这里用 dam_line
    #     south_line=right_line,         # “右岸线”→这里用 right_line
    #     center_line=centerline,
    #     **plot_cfg.get("normals", {})  # <— 包含 x_min/x_max/y_min/y_max/rtree_mode
    # )
    # 6. 封闭形状生成
    ...
    #     closed_shapes,
    #     north_line=dam_line,
    #     south_line=right_line,
    #     center_line=centerline,
    #     **plot_cfg.get("closed_shapes", {})
    # )
    ...
    #     ditches=ditchs,
    #     center_line=centerline,  # 可选
    #     title=f"总览",
    #     save_path=os.path.join(output_dir, f"overview_{job_name}.png"),
    #     auto_figsize=True,  # ✅ 自动按数据比例设画布
    #     base_figsize_width=16,  # 可调
    #     padding_ratio=0.02  # 边界留白比例，可调
    # )
    # 同时保存完整版和干净版
    ...
    #     save_path='output/overview_20250122_full.png',  # 完整版（带标题、图例等）
    #     save_clean_path='output/overview_20250122_clean.png',  # 干净版（仅底图+矢量线）
    #     show_axis=True,
    #     use_proxy=True
    # )
